...
\titlegraphic{\hspace*{-10mm}\vspace*{-10mm}\includegraphics[width=13cm, height=2.5cm]{bonn3.png}}
...
\setbeamertemplate{footline}
{
    \leavevmode%
    \hbox{%
        \begin{beamercolorbox}[wd=.80\paperwidth,ht=2.25ex,dp=1ex,left]{subsection in head/foot}
            \insertsectionnavigationhorizontal{.6\textwidth}{\hskip0pt plus1filll}{}
        \end{beamercolorbox}%
        
        \begin{beamercolorbox}[wd=.20\paperwidth,ht=2.25ex,dp=1ex,right]{section in head/foot}%
...
\title[An ILR Theme for Beamer \LaTeX]{An ILR Theme for Beamer  \LaTeX - Presentations} % The short title appears at the bottom of every slide, the full title is only on the title page
